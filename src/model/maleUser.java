...
public class maleUser extends User{
	...
	public maleUser(String name, int age, String occ, String hobby, String music, String major, String campus, String gendint, int lookingforAge, String lookingforOcc, String lookingforHobby, String lookingforMusic) {
